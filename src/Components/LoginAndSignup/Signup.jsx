...
import { User, Mail, Calendar, Lock, Eye, EyeOff, ArrowRight, UserPlus, Sparkles } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div 
          className="absolute top-0 right-1/4 w-96 h-96 rounded-full blur-3xl opacity-30 animate-pulse"
          style={{
        ...
        ></div>
        <div 
          className="absolute bottom-0 left-1/4 w-96 h-96 rounded-full blur-3xl opacity-20 animate-pulse"
          style={{
        ...
        ></div>
        <div 
          className="absolute top-1/3 right-1/3 w-[500px] h-[500px] rounded-full blur-3xl opacity-15"
          style={{
        ...
        <div className="px-8 sm:px-10 py-10 sm:py-12 pt-16">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="pt-2">
              <label className="flex items-start gap-3 cursor-pointer group">
                <input 
                  type="checkbox" 
                  required
                  className="mt-1 w-4 h-4 rounded accent-pink-500 cursor-pointer"
                  style={{ accentColor: accentColor }}
                />
                <span className="text-xs font-medium leading-relaxed" style={{ color: "#A0A0A0" }}>
                  I agree to the{" "}
                  <span className="font-semibold hover:underline" style={{ color: accentColor }}>
                    Terms & Conditions
                  </span>
                  {" "}and{" "}
                  <span className="font-semibold hover:underline" style={{ color: accentColor }}>
            ...
            {error && (
              ...
              >
                <p className="text-sm font-semibold text-center" style={{ color: "#FF6666" }}>
                  {error}
                </p>
              </div>
            )}
          ...
          <div className="mt-8 flex items-center gap-4">
            <div className="flex-1 h-px" style={{ backgroundColor: "#252525" }}></div>
